...
interface UnionExercise2Props {
  ...
  /** Emite snapshot JSON v2 completo pro pai persistir (step + marks + frações). */
  onPhaseChange?: (phaseId: string) => void;
  /** Snapshot JSON v2 pra restauração pós-F5 no mount. */
...
export const UnionExercise2 = forwardRef<UnionExercise2Handle, UnionExercise2Props>(
  function UnionExercise2({ onFinished, onRequestPreviousPhase, initialStep, createAlert, onPhaseChange, initialPhaseSnapshot }, ref) {
